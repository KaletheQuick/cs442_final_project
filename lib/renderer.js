...
let tex1 = createTexture(gl, "img/albedo.png", 0, 'albedo', shader_program);
let tex2 = createTexture(gl, "img/shine_spec_o_o.png", 1, 'uber_maps', shader_program);
let cubeMapTexture = loadCubeMap(gl);
