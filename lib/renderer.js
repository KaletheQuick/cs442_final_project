...
function compileMatrixArray() {
    let mat0 = Mat4.translation(1,0,0).mul(Mat4.rotation_xy(0.2)).mul(Mat4.rotation_yz(-0.4));
    let mat1 = Mat4.translation(0,1,0).mul(Mat4.rotation_xy(-0.3)).mul(Mat4.rotation_yz(0.1));
    let mat2 = Mat4.translation(-1,-0.5,0).mul(Mat4.rotation_xy(0.2)).mul(Mat4.rotation_yz(-0.1));
    //console.log(mat0.data.concat(mat1.data));
    return mat0.data.concat(mat1.data).concat(mat2.data);
}
...
// GL vars and config
    ...
    verts = meshes["meshes/d4.obj"].to_indexed_render_array(0).concat(meshes["meshes/d4.obj"].to_indexed_render_array(1)).concat(meshes["meshes/diamond.obj"].to_indexed_render_array(2));
